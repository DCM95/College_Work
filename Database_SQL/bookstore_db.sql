...
-- Dumping database structure for dcm0033db
CREATE DATABASE IF NOT EXISTS `dcm0033db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dcm0033db`;

-- Dumping structure for table dcm0033db.db_book
...
INSERT INTO `db_customer` (`CustomerID`, `Last Name`, `First Name`, `Phone`) VALUES
